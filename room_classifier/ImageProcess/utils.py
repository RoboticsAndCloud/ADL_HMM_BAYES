...
TTS_AUDIO_FILE_DIR = "/home/ascc/asccbot_v3/wearable_device_new_design/server/audio_response/"
...
async def getweather():
    ...
    weather = await client.find("Stillwater Oklahoma")

    # returns the current day's forecast temperature (int)
    # print(weather.current.temperature)
    # print(weather)
    # <CurrentForecast date=datetime.datetime(2021, 8, 28, 19, 45) temperature=69 sky_text=Mostly Sunny humidity=35 wind_speed=3>
    # print(weather.current)

    city = 'Stillwater'
    country = 'United States'
    weatherRes = 'It\'s ' + weather.current.sky_text + ' and ' + str(weather.current.temperature) \
                         + '° in ' + city + ', ' + country + '.'
    print(weatherRes)
    ...
    g_utils.weather_res = weatherRes
