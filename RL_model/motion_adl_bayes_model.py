...
ACTIVITY_MASTER_BEDROOM : {MOTION_TYPE_SITTING:0.3, MOTION_TYPE_STANDING:0.8, MOTION_TYPE_WALKING:0.2, MOTION_TYPE_LAYING:0.4}
...
ACTIVITY_CHORES : {AUDIO_TYPE_VACUUM:0.9, AUDIO_TYPE_ENV:MIN_Prob},
