...
env = rl_env_ascc_test.EnvASCC(TEST_BASE_DATE + ' 00:00:00')
env.reset()
...
def real_time_test_run():
    ...
    action_space = list(rl_env_ascc_test.RL_ACTION_DICT.keys())
    ...
    qtable_path = '/home/ascc/LF_Workspace/Bayes_model/IROS23/ADL_HMM_BAYES/RL_model/q_res_energy0.49_privacy_0.49/ascc_q_table.txt_3000'
    qtable_path = '/home/ascc/LF_Workspace/Bayes_model/IROS23/ADL_HMM_BAYES/RL_model/q_res_energy0.49_privacy_0.49/ascc_q_table.txt.0414_5000'
    #qtable_path = '/home/ascc/LF_Workspace/Bayes_model/IROS23/ADL_HMM_BAYES/RL_model/q_res_energy0.49_privacy_0.49/ascc_q_table.txt_1000_256_2'

    agent = rl_ascc_q.QLearningAgent(len(action_space), episodes=500*2.5, epsilon = 0.01)
    ...
    for episode in range(episode_count):
        ...
        while(not env.done):
            ...
            if rl_env_ascc_test.RL_ACTION_DICT[action] == rl_env_ascc_test.WMU_fusion  \
                or rl_env_ascc_test.RL_ACTION_DICT[action] == rl_env_ascc_test.Robot_audio_vision:
                if check_and_wait_l_o_s_m_result() == False:
                    # pass
                    continue
