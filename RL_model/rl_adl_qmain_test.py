...
for episode in range(episode_count):
    ...
    while(not env.done):
        ...
        ignore_time1 =  datetime.strptime('2009-12-11 18:53:00', rl_env_ascc_test.DATE_HOUR_TIME_FORMAT)
        ignore_time2 =  datetime.strptime('2009-12-11 20:36:40', rl_env_ascc_test.DATE_HOUR_TIME_FORMAT)
