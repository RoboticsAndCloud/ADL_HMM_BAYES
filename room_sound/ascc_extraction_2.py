...
/home/ascc/Downloads/total_sound_1_second/flush_toilet
    ...
    for i in labels:
        ...
        sub_dir = "/home/ascc/LF_Workspace/Bayes_model/IROS23/ADL_HMM_BAYES/room_sound/watch-dataset/Audio/" + i
    ...
    np.savez('/home/ascc/LF_Workspace/Bayes_model/Product_ADL/ADL_HMM_BAYES/room_sound/sound_dataset/ascc_activity_1second/feature/ascc_logmel_total_watch.npz',
                train_x=train_feats, train_y=train_labels, test_x=test_feats, test_y=test_labels)
