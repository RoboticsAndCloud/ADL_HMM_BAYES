...
class Model(object):
    ...
    def _forward(self, sequence):
        ...
        for state in self._states:
            ...
            # print('start_prob:', state,' ', self.start_prob(state))
            # print('emit_prob:', state, ' ', self.emit_prob(state, sequence[0]), 'sequence 0:',sequence[0])
            

        # print('start_prob:', self._start_prob)
        # print('============')
        # print('alpha 0:', alpha)
