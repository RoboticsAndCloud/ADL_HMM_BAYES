...
def get_activity_by_motion_dnn(time_str, action='vision', activity = 'kitchen', sensor_type = 'robot'):
    ...
    image_dir_name = "/home/ascc/LF_Workspace/Bayes_model/IROS23/data/" + activity + '/' + sensor_type + '/' + 'Image'
...
def get_activity_by_audio_dnn(time_str, action='vision', activity = 'kitchen', sensor_type = 'robot'):
...
def get_activity_by_vision_yolov3(time_str, action='vision', mode='map', activity = 'kitchen', sensor_type = 'robot'):
...
def get_activity_by_vision_dnn(time_str, action='vision', mode='map', activity = 'kitchen', sensor_type = 'robot'):
