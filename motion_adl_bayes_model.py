...
ACTIVITY_CHORES : {LOCATION_READINGROOM: 0.1, LOCATION_BATHROOM: 0.1, LOCATION_LIVINGROOM: 0.1, LOCATION_KITCHEN: 0.3, LOCATION_LOBBY: 0.1, LOCATION_BEDROOM: 0.2, LOCATION_DININGROOM:0.1},
ACTIVITY_LEAVE_HOME : {LOCATION_DOOR: 0.8, LOCATION_KITCHEN: 0.1, LOCATION_LOBBY: 0.1},
ACTIVITY_READ :{LOCATION_READINGROOM: 0.9, LOCATION_BEDROOM: 0.05, LOCATION_LIVINGROOM:0.04},
ACTIVITY_GUEST_BATHROOM : {LOCATION_BATHROOM: 0.99},
ACTIVITY_MASTER_BATHROOM : {LOCATION_BATHROOM: 0.99},
ACTIVITY_DESK_ACTIVITY : {LOCATION_READINGROOM: 0.5, LOCATION_LIVINGROOM:0.4, LOCATION_KITCHEN: 0.1},
...
ACTIVITY_MORNING_MEDS : {MOTION_TYPE_SITTING:0.8, MOTION_TYPE_STANDING:0.2, MOTION_TYPE_WALKING:0.0},
